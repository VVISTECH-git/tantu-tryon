...
Version 2 of the composition, 2026-09-10. One frozen, four live and awaiting
their test.

| #   | File                                                         | State                                                              |
| --- | ------------------------------------------------------------ | ------------------------------------------------------------------ |
| 1   | [`01-front-symmetrical.md`](01-front-symmetrical.md)         | **frozen v2**, approved 2026-09-10 on 300021                       |
| 2   | [`02-three-quarter.md`](02-three-quarter.md)                 | v2 wording, one approved run on 300021 with the house rules, not frozen |
